...
while true; do
  ...
  case $yn in
  [Yy]* ) break;;
  [Nn]* )  echo && echo -e "\e[1;91mThanks for using Tool.Use for Educational purpose only. \e[1;93mGithub Repository link : \e[1;94m' https://github.com/JayKotadia'." ;exit;;
...
if [ "$options" = "$twentytwo" ]
  ...
  then
      ...
      echo -e "\e[37mGITHUB : \e[4;91mhttps://github.com/JayKotadia\e[0m"
      echo -e
